...
# bnapp.config.suppress_callback_exceptions =True
...
sidebar = html.Div(
    [
        html.H1("Dashboard",className="lead"),
        html.H1("DevOps",className="lead"),
        #html.H1("DevOps",className="display-5"),
        html.Hr(),
        dbc.Nav(
...
def render_page_content(pathname):
    ...
    if pathname == '/pru':
        return html.P("Proceso de Pruebas. Esta fase incluye la realizacion de pruebas continuas (manuales o automatizadas)"
...
# set debug to false when deploying app
 ...
 #app.run_server( host='192.168.1.75', port=8888)
#run_simple('0.0.0.0', 8050, app, use_reloader=True)
